package dodi.respack.fabric.packs;
import dodi.respack.fabric.ResourcePackOrganizer;
...
public final class ResourcePackFolder extends ClientResourcePackProfile{
	private static final Identifier folderResource = new Identifier("ResourcePackOrganizerCustom:textures/gui/folder.png"); // http://www.iconspedia.com/icon/folion-icon-27237.html
	
	static{
		// for some reason the texture fails to load in the actual game
		try(InputStream stream = ResourcePackFolder.class.getResourceAsStream("/assets/ResourcePackOrganizerCustom/textures/gui/folder.png")){
